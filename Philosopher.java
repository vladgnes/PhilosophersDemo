...
public class Philosopher implements Runnable {
    ...
    public void takeLeftFork(Fork fork) throws InterruptedException{
        synchronized (fork) {
            if (!fork.taken) {
                ...
                Thread.sleep(3000);//if a fork is taken, wait 3 second
    ...
    public void takeRightFork(Fork fork) throws  InterruptedException {
        synchronized (fork) {
            if (!fork.taken) {
                ...
                Thread.sleep(3000);//if a fork is taken, wait 3 second and check again
    ...
    public void think() throws InterruptedException {
        ...
        Thread.sleep(5000);//thinking during 5 seconds
    ...
    public void eat(Fork leftFork, Fork rightFork) throws InterruptedException{
        ...
        Thread.sleep(5000);//eating during 5 seconds
